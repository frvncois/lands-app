    ...
    <div class="max-w-[600px] mx-auto w-full text-center flex flex-col items-center gap-[var(--spacing-md)]">
      ...
      >
        <input
          ...
          class="flex-1 py-[var(--btn-py)] px-[var(--spacing-md)] bg-[var(--color-surface)] text-[var(--color-fg)] text-[length:var(--text-base)] rounded-[var(--btn-radius)] border border-[var(--color-border)] outline-none transition-colors"
        ...
        <button
          type="submit"
          class="py-[var(--btn-py)] px-[var(--btn-px)] bg-[var(--color-primary)] text-[var(--color-primary-fg)] text-[length:var(--text-base)] font-[var(--btn-weight)] rounded-[var(--btn-radius)] transition-opacity whitespace-nowrap"
          :class="isEditing && 'cursor-pointer'"
