...
import type { FooterSettings, FooterStyles } from '@/types/editor'
...
const settings = computed(() => selectedBlock.value?.settings as FooterSettings)
const styles = computed(() => effectiveBlockStyles.value as FooterStyles)
</script>
