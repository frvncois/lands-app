...
import { formInputTypeOptions } from '@/lib/editor-utils'
import type { FormInputSettings, FormInputStyles } from '@/types/editor'
...
const settings = computed(() => selectedBlock.value?.settings as FormInputSettings)
const styles = computed(() => effectiveBlockStyles.value as FormInputStyles)
</script>
  ...
  <div v-if="selectedBlock">
    ...
    <InspectorSection title="Input Settings" icon="content-form">
      ...
      <InspectorField label="Input Type">
        <SelectInput
          :model-value="settings.inputType"
