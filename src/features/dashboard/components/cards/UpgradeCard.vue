...
<template>
  <div class="flex-1 shrink-0 card-appear rounded-xl border bg-gray-50 border-gray-200 justify-center p-8 flex flex-col items-center gap-2 text-center" style="animation-delay: 400ms">
