...
import { headingLevelOptions, alignmentOptions, fontWeightOptions } from '@/lib/editor-utils'
import type { HeadingSettings, HeadingStyles } from '@/types/editor'
...
const settings = computed(() => selectedBlock.value?.settings as HeadingSettings)
const styles = computed(() => effectiveBlockStyles.value as HeadingStyles)
  ...
  <div v-if="selectedBlock">
    ...
    <InspectorSection title="Style" icon="style-color">
      ...
      <InspectorField label="Font Size" horizontal>
        <FontSizeSlider
          :model-value="styles.fontSize || 'xl'"
      ...
      <InspectorField label="Font Weight" horizontal>
        <SelectInput
          ...
          :model-value="styles.fontWeight || 'bold'"
