...
import type { FormRadioSettings, FormRadioStyles, FormSelectOption } from '@/types/editor'
...
const settings = computed(() => selectedBlock.value?.settings as FormRadioSettings)
const styles = computed(() => effectiveBlockStyles.value as FormRadioStyles)
