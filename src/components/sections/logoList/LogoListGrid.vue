...
/**
 * LOGO LIST - GRID VARIANT
 *
 * Horizontal layout with optional header.
 * Content (headline/subheadline/paragraph) above logos.
 * Logos in a horizontal flex row that wraps.
 *
 * Item styles:
...
<template>
  ...
  >
    <div class="max-w-[1200px] mx-auto w-full flex flex-col gap-[var(--spacing-lg)]">
      <!-- Content Header -->
      <div
      ...
      <!-- Logos Row -->
      <div class="flex flex-wrap items-center justify-center gap-[var(--spacing-xl)]">
